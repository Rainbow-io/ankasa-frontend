...
const BookingDetail = () => {
    ...
    const dataTicketsSuccess = useSelector((state) => state.BookingSuccess)
    ...
    let ticketsArray = []
    for (let i = 1; i <= dataTicketsSuccess.data.list_passenger; i++) {
        ticketsArray.push(i)
    }

    // const ticketsArray = Array(2).fill(null)
            ...
            <div className="d-none d-lg-flex justify-content-center">
                <div className="my-5 bg-white card-white w-75">
                    <div className="mx-5 my-5 content-inner">
                        ...
                        {ticketsArray.map((passenger, index) => {
                            return (
                                    ...
                                    <div className="border ticket-border-left">
                                        <div className='px-3 py-3 ticket-content-left'>
                                            <div className="d-flex airline-info">
                                                ...
                                                <div className="fw-bold fs-3 px-5">{dataTicketsSuccess.data.departure}</div>
                                                <img className="mb-1" src={require("../../../assets/icons/to-plane-bookingdetail.svg").default} alt="to-plane-bookingdetail" />
                                                <div className="fw-bold fs-3 px-5">{dataTicketsSuccess.data.arrival}</div>
                                            </div>
                                                ...
                                                <div className="d-flex detail-info-inner">
                                                    <div className="left">
                                                        ...
                                                        <div className="departure">
                                                            <div className="text-muted">Departure</div>
                                                            <div>{dataTicketsSuccess.data.date}, {dataTicketsSuccess.data.departure_time}</div>
                                                        </div>
                                                    </div>
                                                    <div className="kanan">
                                                        <div className="class mb-3">
